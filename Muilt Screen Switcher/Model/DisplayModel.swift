...
class DisplayModel: NSObject, NSCoding {
    ...
    init(_ screen: NSScreen) {
        ...
        screen_id = screen_info[NSDeviceDescriptionKey(rawValue: "NSScreenNumber")] as! CGDirectDisplayID
        let screen_size = screen_info[.size] as! NSSize
    ...
    required init?(coder aDecoder: NSCoder) {
        screen_id = aDecoder.decodeObject(forKey: "screen_id") as! CGDirectDisplayID
        screen_width = aDecoder.decodeInt32(forKey: "screen_width")
        screen_height = aDecoder.decodeInt32(forKey: "screen_height")
        position_x = aDecoder.decodeInt32(forKey: "position_x")
        position_y = aDecoder.decodeInt32(forKey: "position_y")
    }
